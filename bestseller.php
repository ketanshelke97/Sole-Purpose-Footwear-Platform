...
<body>
        ...
        <section class="product-page">
            ...
            <div class="product-grid">
                ...
                <div class="product-card">
                    <img src="images/TWL(men).jpg" alt="Tan Suede Loafer" class="product-image">
                ...
                <div class="product-card">
                    <img src="images/TCL(men).jpg" alt="Black Classic Loafer" class="product-image">
                ...
                <div class="product-card">
                    <img src="images/TOC(men).jpg" alt="Brown Oxford Shoe" class="product-image">
                ...
                <div class="product-card">
                    <img src="images/boots(unisex).jpg" alt="Brown Work Boot" class="product-image">
                ...
                <div class="product-card">
                    <img src="images/slides(unisex).jpg" alt="Comfortable Slide" class="product-image">
                ...
                <div class="product-card">
                    <img src="images/TWL(Women).jpg" alt="Tan Suede Loafer" class="product-image">
                ...
                <div class="product-card">
                    <img src="images/TCL(women).jpg" alt="Black Classic Loafer" class="product-image">
                ...
                <div class="product-card">
                    <img src="images/heels.jpg" alt="Merlot Pointed Heel" class="product-image">
    ...
    <!-- This loads your existing JavaScript file -->
